...
namespace HoloToolkit.Unity.InputModule {
    ...
    /// </summary>
    public class DragAndThrow : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler {
        ...
        public void OnSourceLost(SourceStateEventData eventData) {
            if (currentInputSource != null && eventData.SourceId == currentInputSourceId) StopDragging();
        }
        ...
        public void SetDragging(bool isEnabled) {
            if (IsDraggingEnabled == isEnabled) return;
        ...
        private void Update() {
            if (IsDraggingEnabled && isDragging) UpdateDragging();
        }
        ...
        private void UpdateDragging() {
            ...
            currentInputSource.TryGetPointerPosition(currentInputSourceId, out inputPosition);
                        #endif
            //Saving the last position to get the velocity
            ...
            } else if (RotationMode == RotationModeEnum.LockObjectRotation) { draggingRotation = HostTransform.rotation; } else // RotationModeEnum.Default
            {
